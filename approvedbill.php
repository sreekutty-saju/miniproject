...
$a=" select job_id,job_name,area_coverage,str_date,end_date,localAdmin_id,esitmated_amt FROM jobcard_register where ws=1 and appr=0";
$b=mysqli_query($c,$a);
//$d=mysqli_fetch_array($b);
           ...
           echo "<tr>";
            ...
            echo "</td><td class=body-item mbr-fonts-style display-7>";
            echo "<a href=http://localhost/nrems2/profile/web/billupdate.php?id=$r[job_id]><button name=accept class=b>APPROVE</button></a>";
            echo "</td></tr>";
   ...
   <a href="http://localhost/nrems2/profile/web/viewapprovedbill.php"> <button class="b2">View Approved bills</a></button>
