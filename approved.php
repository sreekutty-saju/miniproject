          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              ...
              <th class="head-item mbr-fonts-style display-7">
                      ...
                      LOCAL BODY ID</th><th class="head-item mbr-fonts-style display-7">
                      LOCAL BODY NAME</th><th class="head-item mbr-fonts-style display-7">
                      USER NAME</th><th class="head-item mbr-fonts-style display-7">
                      DISTRICT</th><th class="head-item mbr-fonts-style display-7">
                      STATE</th><th class="head-item mbr-fonts-style display-7">
                      PH</th>
                      </tr>
            </thead>
...
$a="select * from local_admin where is_ver=1";
$b=mysqli_query($c,$a);
